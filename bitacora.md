...
let beat = stack(
   s("oh").beat("5, 7, 11, 13", 16).visualid("drum_oh"),
   s("hh").beat("0, 4, 6, 8, 10, 12, 14", 16).visualid("drum_hh"),
   s("cp").beat("1, 5, 8, 11, 14, 15", 16).visualid("drum_cp"),
   s("bd").beat("0, 4, 7, 10, 13", 16).visualid("drum_bd")
).bank("RolandTr909")
